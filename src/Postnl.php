        ...
        try {
            ...
            if ($exception->faultcode == 's:CIF Framework Message Interceptor') {
                ...
                $exceptionData = ComplexTypes\ExceptionData::create()
                        ->setDescription($exception->detail->CifException->Errors->ExceptionData->Description)
                        ->setErrorMsg($exception->detail->CifException->Errors->ExceptionData->ErrorMsg)
                        ->setErrorNumber($exception->detail->CifException->Errors->ExceptionData->ErrorNumber);
